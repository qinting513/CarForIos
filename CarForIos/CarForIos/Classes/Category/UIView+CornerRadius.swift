...
public extension UIView {
    public func xc_setCornerRadius(_ radius: CGFloat) {
        xc_setCornerRadius(radius, backgroundColor: backgroundColor ?? .white)
    }
    
    public func xc_setCornerRadius(_ radius: CGFloat, backgroundColor: UIColor) {
        xc_setCornerRadius(radius, backgroundColor: backgroundColor, corners: .allCorners)
    }
    
    public func xc_setCornerRadius(_ radius: CGFloat, backgroundColor: UIColor, corners: UIRectCorner) {
        xc_setCornerRadii(CGSize(width: radius, height: radius), backgroundColor: backgroundColor, corners: corners, borderColor: nil, borderWidth: nil)
    }
    
    public func xc_setCornerRadii(_ cornerRadii: CGSize, backgroundColor: UIColor, corners: UIRectCorner, borderColor: UIColor?, borderWidth: CGFloat?) {
        ...
        layer.xc_roundedCorner(cornerRadii, cornerColor: backgroundColor, corners: corners, borderColor: borderColor, borderWidth: borderWidth)
    }
}


public extension CALayer {
    public func xc_roundedCorner(_ cornerRadii: CGSize, cornerColor: UIColor, corners: UIRectCorner, borderColor: UIColor?, borderWidth: CGFloat?) {
        let key = "Identifier_\(cornerRadii)_\(cornerColor)_\(corners)_\(String(describing: borderColor))_\(String(describing: borderWidth))"
    ...
    private struct XBAssociatedKeys {
        static var cornerLayerIdentifierKey = "xc_cornerLayerIdentifierKey"
    }
